...
Deno.serve(async (req) => {
    ...
    const bucketConfig = {
        id: 'conversation-screenshots',
        name: 'conversation-screenshots',
        public: true
    };
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for conversation-screenshots" ON storage.objects FOR SELECT USING (bucket_id = 'conversation-screenshots');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for conversation-screenshots" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'conversation-screenshots');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for conversation-screenshots" ON storage.objects FOR UPDATE USING (bucket_id = 'conversation-screenshots');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for conversation-screenshots" ON storage.objects FOR DELETE USING (bucket_id = 'conversation-screenshots');`
    ];
